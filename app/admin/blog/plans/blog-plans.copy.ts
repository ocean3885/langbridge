export const blogPlansCopy = {
  ko: {
    ...
    draftGenerated: '원고 있음',
    draftNotGenerated: '원고 없음',
    jsonGenerated: 'JSON 있음',
    jsonNotGenerated: 'JSON 없음',
    generatedPreview: '생성 결과 확인',
    generatedDraft: '생성된 글',
    generatedJson: '변환된 JSON',
    postGenerated: '글 원고를 생성했습니다.',
    postJsonGenerated: '글 원고를 JSON으로 변환했습니다.',
    postGenerateError: '글 생성에 실패했습니다.',
    postJsonGenerateError: 'JSON 변환에 실패했습니다.',
  ...
  en: {
    ...
    draftGenerated: 'Draft ready',
    draftNotGenerated: 'No draft',
    jsonGenerated: 'JSON ready',
    jsonNotGenerated: 'No JSON',
    generatedPreview: 'Generated output',
    generatedDraft: 'Generated draft',
    generatedJson: 'Generated JSON',
    postGenerated: 'Draft generated.',
    postJsonGenerated: 'Draft converted to JSON.',
    postGenerateError: 'Failed to generate post.',
    postJsonGenerateError: 'Failed to convert JSON.',
