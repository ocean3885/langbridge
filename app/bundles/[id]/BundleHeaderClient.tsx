...
export default function BundleHeaderClient({ bundle, itemsCount, language }: BundleHeaderClientProps) {
  ...
  return (
    <div className="bg-white rounded-2xl md:rounded-3xl shadow-sm border border-gray-100 overflow-hidden mb-4 md:mb-8 transition-all duration-300">
      <div className="p-4 md:p-8 flex flex-col justify-center">
        <div className="flex flex-wrap items-center gap-2 mb-2 md:mb-3">
          <span className="px-2 py-0.5 md:px-3 md:py-1 bg-blue-50 text-blue-600 text-[10px] md:text-xs font-black rounded-full uppercase tracking-wider">
          ...
          <div className="flex items-center gap-1 md:gap-2 text-[10px] md:text-xs text-gray-400 font-medium">
            <span className="bg-gray-100 px-2 py-0.5 rounded-md text-gray-500 font-bold">{t.totalItems(itemsCount)}</span>
        ...
        <div className="flex items-start justify-between gap-4">
          ...
          <button 
            ...
            className="mt-1 p-2 bg-gray-50 hover:bg-blue-50 text-gray-400 hover:text-blue-600 rounded-full transition-colors flex-shrink-0"
