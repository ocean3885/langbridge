...
export function BundleCard({ bundle, index, language }: { bundle: BundleRow; index: number; language: Language }) {
  ...
  return (
    <Link
      ...
      className="group min-w-[150px] overflow-hidden rounded-lg border border-zinc-200 bg-white shadow-sm transition hover:-translate-y-0.5 hover:shadow-md dark:border-zinc-800 dark:bg-zinc-900 dark:shadow-black/20 dark:hover:border-zinc-700"
    >
      <div className="relative aspect-[2.1/1] overflow-hidden bg-[#f3ede3] dark:bg-zinc-800 sm:aspect-[2.3/1]">
        <Image
      ...
      <div className="p-4">
        <h3 className="line-clamp-2 min-h-10 text-sm font-bold leading-5 text-zinc-900 dark:text-zinc-100">{title}</h3>
